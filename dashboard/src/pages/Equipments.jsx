...
import { useCategories } from "../features/equipments/useCategories";
...
// import UpdatCategories from "../features/equipments/UpdatCategories";
// const dt = [
//   {
//     name: "Steam Boiler\nView Details",
...
function Equipments() {
  ...
  const goToCategories = () => navigate("/equipments/categories");
