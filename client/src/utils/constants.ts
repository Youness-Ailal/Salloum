...
export const RECAPTCHA_KEY = "6LcxaToqAAAAANxhMadt3VmKWzej5tx40Rd9nD8J";
...
export const questions: faqType[] = [
  ...
  {
    question: "Does your company handle the export paperwork with customs?",
    answer:
      "Yes, our company manages the export paperwork and is registered with CargoX for exports to Egypt.",
  },
  {
